    ...
    >
      <ScrollView contentContainerStyle={styles.inner}>
        ...
        <View style={styles.sectionHeader}>
          ...
          <Image source={require('../../assets/images/Line.png')} style={styles.fullWidthLine} />
        </View>
        ...
        <View style={styles.choiceContainer}>
          ...
          <Pressable onPress={() => setActiveButton('global')} style={styles.choice}>
            ...
            {activeButton === 'global' && (
              <Image source={require('../../assets/images/Check.png')} style={styles.choiceCheck} />
            )}
          </Pressable>

          <Image source={require('../../assets/images/Line.png')} style={styles.shortLine} />
          ...
          <Pressable onPress={() => setActiveButton('friends')} style={styles.choice}>
            <View style={styles.choiceLeft}>
              ...
              <View>
                ...
                <Text style={[styles.choiceDescription, { color: activeButton === 'friends' ? colors.textMain : colors.textSub }]}>
          ...
          <Pressable onPress={() => setActiveButton('Business')} style={styles.choice}>
            <View style={styles.choiceLeft}>
              <Image
                ...
                style={[styles.choiceIcon, { tintColor: activeButton === 'Business' ? colors.primary : colors.textSub }]}
              />
              <View>
                <Text style={[styles.choiceText, { color: activeButton === 'Business' ? colors.textMain : colors.textSub }]}>
                  İş Sohbet
                </Text>
                <Text style={[styles.choiceDescription, { color: activeButton === 'Business' ? colors.textMain : colors.textSub }]}>
        ...
        <Image source={require('../../assets/images/Line.png')} style={[styles.fullWidthLine, { marginTop: SCREEN_HEIGHT * 0.015, marginBottom: SCREEN_HEIGHT * 0.015 }]} />
