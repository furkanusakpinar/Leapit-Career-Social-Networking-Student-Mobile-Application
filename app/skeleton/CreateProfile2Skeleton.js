  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        <Shimmer style={styles.userProfile} colors={colors} styles={styles} />
        ...
        <View style={{ flexDirection: 'row', gap: 12 }}>
          <Shimmer style={styles.userCard} colors={colors} styles={styles} />
          <Shimmer style={styles.userCard} colors={colors} styles={styles} />
        </View>
...
export default CreateProfile2Skeleton;
