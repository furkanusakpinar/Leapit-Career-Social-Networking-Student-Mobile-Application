      ...
      >
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <Pressable onPress={() => setShowLogoutModal(true)} style={styles.iconButton}>
          ...
          {[settingsOptions, settingsOptions2].map((group, gi) => (
            <View key={gi} style={[styles.card, gi === 1 && { marginTop: 20 }]}>
              ...
              {}
              {gi === 1 && (userData?.email === 'leapitapp@gmail.com' || userData?.isAdmin) && (
                <>
                  ...
                  >
                    <Text style={[styles.optionText, {color: colors.primary, fontWeight: 'bold'}]}>İş İlanı Onayları</Text>
                    <Image source={require('../../assets/images/Arrow.png')} style={styles.arrowIcon} />
                  </Pressable>
                </>
              )}
      ...
      <Modal animationType="fade" transparent visible={showLogoutModal} onRequestClose={() => setShowLogoutModal(false)}>
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            <Text style={styles.modalMessage}>Oturumu kapatmak istediğinizden emin misiniz?</Text>
...
const getStyles = (colors) => StyleSheet.create({
  ...
  backIcon: { width: 24, height: 24, resizeMode: 'contain', tintColor: colors.iconTint },
  logoutIcon: {
    width: 24,
    height: 24,
    resizeMode: 'contain',
